...
/*                   : (images.length===0 
                      ...
                      :  <div>
                            <TopicsGallery />
                            { selectedTopic==="" 
                                ? <Button onClick={console.log(images.length)}>Click on images for details</Button> 
                                : <Details />
                            }
                        </div>}
                        </>
...
{/*         <StyledPaper message={"Visual " + selectedTopic}>
        ...
        <StyledPaper  message={selectedTopic + " in Words"}>
              <Textual year={selectedYear} topic={selectedTopic} user_ref={user_ref}/>
        </StyledPaper>
        <StyledPaper message={selectedTopic + " in Metrics"}>
